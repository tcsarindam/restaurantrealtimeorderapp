            ...
            <tr class="glf-gray-bg">
                <td nowrap="true" class="glf-cell" style="text-align: center;">
                    ...
                    <div style="box-sizing: border-box; white-space: normal; display: flex;margin-top: 16px;margin-left: 0;align-items: center;">
                        <button class="button button-primary" onClick="glfUpdateFullMenu(this)" style="margin-left:0;" data-page="<?php menu_page_url( 'glf-publishing', true ); ?>" style="margin-right: 18px; margin-left: 20px;">Refresh menu
                        </button><span style="font-style: normal; line-height: 1.3; margin-left:36px; text-align: left;">Hit Refresh menu to publish your menu edits on the website.</span>
                    </div>
                </td>
            </tr>
            </tbody>
...
<div class="settings-account glf-settings-content">
    <div class="glf-wrapper">
        <div class="glf-section glf-spacing-v1 flx-col">
            <div class="section-title big">You are already logged in</div>
            <div class="glf-section-content glf-white-back flx-col flx-align-left">
                <div class="glf-form" style="padding:0px;">
                    <div class="glf-form-notification info" data-type="success">If you disconnect your account, the See Menu & Order and Table Reservation buttons that are already published on your pages will remain as they are. However, you will not longer be able to make changes to your restaurant profile from within the WordPress interface.</div>
                </div>
            </div>
            ...
            <div class="glf-section-content account glf-w-544 glf-white-back flx-col flx-align-left glf-spacing-v1">
                <div class="section-title">Help us improve GloriaFood</div>
                <div class="glf-overlay-text glf-gap-top-8 glf-gap-bottom-24">
                    <span>Become a super contributor by opting in to share non-sensitive plugin data and to receive periodic email updates from us. <a href="https://www.gloriafood.com/privacy" target="_blank">Learn more</a></span>
                </div>
                <div class="glf-switch-control">
                    ...
                    <div class="switch-label">Share usage data</div>
                </div>
            </div>
        </div>
    </div>
